...
MANUFACTURER_RULES = [
    ...
    ("PIPER", ["PIPER"]),
    ("BELL", ["BELL"]),
    ("MCDONNELL DOUGLAS", ["MCDONNELL", "DOUGLAS", "HUGHES", "MD HELICOPTER"]),
    ("LOCKHEED", ["LOCKHEED"]),
    ("DEHAVILLAND", ["DEHAVILLAND", "DE HAVILLAND", "DEHAVILAND", "DEHAVND", "DEHAVLND"]),
    ("SIKORSKY", ["SIKORSKY"]),
    ("EUROCOPTER", ["EUROCOPTER", "AEROSPATIALE", "AEROSPATIAL", "AEROSPATLE", "AEROSATLE"]),
    ("ROBINSON", ["ROBINSON"]),
    ("GRUMMAN", ["GRUMMAN"]),
    ("FAIRCHILD", ["FAIRCHILD", "SWEARINGEN"]),
    ("AERO COMMANDER", ["AERO COMMANDER", "AERO COMDR", "AERO CMDR", "AERO-COMDR", "AERO COMM", "AERO COMNDR"]),
    ("HILLER", ["HILLER"]),
    ("BRITISH AEROSPACE", ["BRITISH AEROSPACE", "BRITTEN", "BRITTNORMAN", "BRITTEN-NORMAN"]),
    ("PILATUS", ["PILATUS"]),
    ("SAAB", ["SAAB"]),
    ("MITSUBISHI", ["MITSUBISHI"]),
    ("FOKKER", ["FOKKER"]),
    ("CONVAIR", ["CONVAIR"]),
    ("LEAR", ["LEAR JET", "LEARJET", "LEAR", "GATES LEAR"]),
    ("SHORTS", ["SHORT BROTHERS", "SHORT BROS", "SHORTS"]),
    ("EUROCOPTER/MBB", ["MBB", "BOLKOW"]),
    ("AEROSTAR", ["AEROSTAR", "SMITH, TED", "TED SMITH"]),
    ("ATR", ["ATR"]),
    ("ROCKWELL", ["ROCKWELL"]),
    ("DORNIER", ["DORNIER"]),
    ("HELIO", ["HELIO"]),
